...
extern "C" {
    pub fn avb_get_algorithm_hash_size(algorithm: AvbAlgorithmType) -> usize;
}
#[repr(C, packed)]
#[derive(Debug, Default, Copy, Clone)]
...
extern "C" {
    pub fn avb_cert_validate_vbmeta_public_key(
        ops: *mut AvbOps,
        public_key_data: *const u8,
        public_key_length: usize,
        public_key_metadata: *const u8,
...
extern "C" {
    pub fn avb_cert_generate_unlock_challenge(
        cert_ops: *mut AvbCertOps,
        out_unlock_challenge: *mut AvbCertUnlockChallenge,
    ) -> AvbIOResult;
}
extern "C" {
    pub fn avb_cert_validate_unlock_credential(
        cert_ops: *mut AvbCertOps,
        unlock_credential: *const AvbCertUnlockCredential,
        out_is_trusted: *mut bool,
    ) -> AvbIOResult;
}
